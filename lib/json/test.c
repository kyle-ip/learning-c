...
/* 验证 lept_get_array_size() 返回值是否正确，但 ANSI C (C89) 没有 size_t 打印方法，在 C99 加入了 “%zu”，但 VS2015 中才有，之前的 VC 版本使用非标准的 "%Iu"
 * 因此使用条件编译去区分 VC 和其他编译器。
 * */
#if defined(_MSC_VER)
